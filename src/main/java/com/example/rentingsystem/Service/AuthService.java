...
public class AuthService {
    ...
    public void addRenter(RenterDTO renterDTO){
        ...
        authRepository.save(user);
        Renter renter = new Renter(null,renterDTO.getPhoneNumber(),renterDTO.getName(),renterDTO.getStatus(),renterDTO.getEmail(),0,null,null,null);
        renter.setUser(user);
        renterRepository.save(renter);
    }
    //
    public void addLessor(LessorDTO lessorDTO){
        ...
        Lessor lessor = new Lessor(null,lessorDTO.getName(),lessorDTO.getEmail(),lessorDTO.getStatus(),lessorDTO.getPhoneNumber(),0.0,0,0.0,null,null,null,null,null,null);
        lessor.setUser(user);
        lessorRepository.save(lessor);
    }
